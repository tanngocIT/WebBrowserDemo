...
namespace WebBrowserDemo
{
    internal class KeyboardHandler : IKeyboardHandler
    {
        ...
        public static List<WebBrowserHotKey> Hotkeys = new List<WebBrowserHotKey>();
        ...
        public static void AddHotKey(Form form, Action function, Keys key, bool ctrl = false, bool shift = false, bool alt = false)
        {
            ...
            Hotkeys.Add(new WebBrowserHotKey(function, key, ctrl, shift, alt));
        }

        public KeyboardHandler(Main form)
        {
            myForm = form;
        }
		...
		public bool OnKeyEvent(IWebBrowser browserControl, IBrowser browser, KeyType type, int windowsKeyCode, int nativeKeyCode, CefEventFlags modifiers, bool isSystemKey)
        {
            if (type == KeyType.RawKeyDown)
            {
                ...
                foreach (WebBrowserHotKey key in Hotkeys)
                {
